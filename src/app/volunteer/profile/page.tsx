  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            ...
            <p className="text-blue-600 font-medium flex items-center gap-2">
              <Heart className="w-4 h-4" /> Tình nguyện viên
            </p>
          </div>
        </div>
        ...
        <button className="mt-8 w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition-colors">
          Cập nhật thông tin
        </button>
      </div>
    </div>
